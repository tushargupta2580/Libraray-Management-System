...
public class StudentRegister extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String stugen=jTextField8.getText();
            String stubooksissued=jTextField9.getText();
            String stusecques=jTextField10.getText();
            String stusecans=jTextField11.getText();

            String qry= "insert into tbstudent values('"+stuid+"','" +stupwd+"','"+stuname+"','"+stuadd+"','"+stustream+"',"  +stusem+","+sturollno+", '"+stumobno+"','"+stugen+"',"+stubooksissued+",'"+stusecques+"','"+stusecans+"')";
